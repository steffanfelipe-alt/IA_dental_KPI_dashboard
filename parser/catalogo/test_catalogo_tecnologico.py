...
Sin pytest: corre con `python -m parser.catalogo.test_catalogo_tecnologico`.
...
from parser.catalogo.catalogo_tecnologico import (
    ETAPAS,
    INTERVENCIONES,
...
from parser.vocabulario.schema import KPI_BY_ID, VARIABLE_TYPES
