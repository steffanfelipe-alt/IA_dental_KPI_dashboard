...
from parser.cobertura_calidad.agregados import calcular_agregado
from parser.cobertura_calidad.reconciliacion import FUENTE_DERIVADA
from parser.vocabulario.schema import KPI_FORMULAS, INTERNAL_VARIABLES, SOLO_MIGRACION_O_SISTEMA, VARIABLE_TYPES
from parser.cobertura_calidad.preguntas_wizard import obtener_pregunta
from parser.cobertura_calidad.trazabilidad import Trazabilidad, explicar
