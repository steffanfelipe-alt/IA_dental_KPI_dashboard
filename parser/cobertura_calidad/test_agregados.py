...
Sin pytest: corre con `python -m parser.cobertura_calidad.test_agregados`.
...
from parser.cobertura_calidad.agregados import calcular_agregado, detectar_outliers
from parser.evals import casos_dorados as dorado
from parser.evals.generar_fixtures import CONSULTAS_NUEVAS, MESES
