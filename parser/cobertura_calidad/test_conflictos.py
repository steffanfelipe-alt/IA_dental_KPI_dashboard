...
Sin pytest (no está instalado en el entorno): corre con `python -m parser.cobertura_calidad.test_conflictos`.
Casos del plan "resolución de conflictos de variables migradas".
"""

from parser.cobertura_calidad.coverage import VariableValue
from parser.cobertura_calidad.conflictos import fusionar_candidatos, resolver_conflictos, UMBRAL_EMPATE
