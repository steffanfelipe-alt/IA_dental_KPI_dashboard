...
Sin pytest: corre con `python -m parser.cobertura_calidad.test_derivacion`.
...
from parser.cobertura_calidad.derivacion import CONFIANZA_DERIVADA, derivar_variables_faltantes
