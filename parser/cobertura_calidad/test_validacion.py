...
Sin pytest: corre con `python -m parser.cobertura_calidad.test_validacion`.
...
from parser.cobertura_calidad.validacion import validar_variable, validar_identidades, IDENTIDADES
