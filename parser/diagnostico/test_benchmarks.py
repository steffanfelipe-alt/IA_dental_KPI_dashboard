...
Sin pytest (no está instalado en el entorno): corre con `python -m parser.diagnostico.test_benchmarks`.
Criterios de aceptación del plan maestro de benchmarks + interpretación.
"""

from parser.diagnostico import aranceles_com
from parser.diagnostico.benchmarks import BENCHMARKS_AR, calcular_gap
from parser.interpretacion.interpretacion import interpretar_kpi, peso_benchmark_vs_historial
from parser.diagnostico.priorizacion import calcular_score, priorizar_kpis
...
def test_contexto_cualitativo_distinto_segun_respuestas():
    from parser.interpretacion.interpretacion import construir_contexto_cualitativo
