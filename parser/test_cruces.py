...
`python3 test_cruces.py`. Fase B del plan de evolución — cruces
determinísticos fuera de las 20 KPIFormula fijas.
"""
...
from schema import ETAPAS_EMBUDO
...
# ---------------------------------------------------------------------------
# Orquestador: deduplicación contra el catálogo de 20 KPIs
# ---------------------------------------------------------------------------
...
def test_generar_cruces_excluye_los_7_pares_ya_en_el_catalogo():
    ...
    assert interseccion == set(), f"estos pares ya los calcula el catálogo de 20 KPIs: {interseccion}"
