...
Sin pytest: corre con `python3 test_priorizacion_extendida.py`.
...
from diagnostico import Diagnostico, EstadoEvidencia, diagnosticar
from priorizacion import calcular_score, calcular_score_diagnostico, priorizar_oportunidades
