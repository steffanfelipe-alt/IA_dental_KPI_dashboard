...
Sin pytest: corre con `python -m parser.vocabulario.test_formato`.
Hallazgo 1.2 del informe de deficiencias: el agente devolvía números
crudos ("15000") en vez de formateados ("$15.000").
"""

from parser.vocabulario.formato import fmt_ars, fmt_pct, fmt_horas, fmt_numero, fmt_por_unidad
