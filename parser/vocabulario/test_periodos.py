...
Sin pytest: corre con `python -m parser.vocabulario.test_periodos`.
...
from parser.vocabulario.periodos import agrupar_por_periodo, es_canonico, normalizar_periodo, orden_cronologico
